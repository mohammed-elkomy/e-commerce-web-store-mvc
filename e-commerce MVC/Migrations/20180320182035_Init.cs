        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    appeared_count = table.Column<int>(type: "int", nullable: true),
                    enabled = table.Column<byte[]>(type: "varbinary(1)", maxLength: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Visacard = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    readed = table.Column<byte[]>(type: "binary(1)", nullable: false),
                    sender_email = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    sender_name = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    subject = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    on_sale = table.Column<byte[]>(type: "binary(1)", nullable: false),
                    price = table.Column<double>(type: "float", nullable: true),
                    sale_info = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_itemTag_products",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_itemTag_tags",
                        column: x => x.tag_id,
                        principalTable: "tags",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    arrived = table.Column<byte[]>(type: "binary(1)", nullable: false),
